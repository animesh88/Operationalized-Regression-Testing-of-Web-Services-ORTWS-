...
public class VisitingClassMethod {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputStream in1 = new FileInputStream("D:\\others\\RTST\\BookService\\BooKService-New\\BooKService.java");
        ...
        new MethodVisitor().visit(cu, "Operations");
    }
    ...
    public static class OperationVisitor extends VoidVisitorAdapter {
