...
public class BuildMessage {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        String fileNameRead = "C:\\Users\\Animesh2\\Documents\\ICSME Tool Demo\\ORTWS\\Eucalyptus\\Eucalyptus WSDL\\Eucalyptus new WSDL.xml";
        File file = new File(fileNameRead);
        String[] s = {"GetVerseByBooKAndChapterAndVerseNumber", null};
